...
/**
 * Refined abstraction. Extends the abstraction's interface. Refined
 * abstraction and abstraction typically define higher-level
 * operation based on the primitives given by the implementor.
 * 
 * @author billy
 *
 */
